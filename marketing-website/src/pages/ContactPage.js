        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@pizoo.ch" className="text-primary-500 hover:underline">
                      hello@pizoo.ch
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+41123456789" className="text-primary-500 hover:underline">
                      +41 12 345 67 89
                    </a>
                  </div>
                </div>
              ...
              {/* Social Media */}
              <div className="mt-12">
                <h3 className="font-semibold text-gray-900 mb-4">{t('contact.social.title')}</h3>
                <div className="flex gap-4">
                  <a href="#" className="w-12 h-12 bg-gray-100 hover:bg-primary-500 hover:text-white rounded-full flex items-center justify-center transition-colors">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 gradient-bg text-white font-semibold rounded-full hover:shadow-lg transition-shadow flex items-center justify-center gap-2"
                >
